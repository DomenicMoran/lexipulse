...
export const metadata: Metadata = {
  ...
  title: {
    default: 'LexiPulse — PDF-Reader, E-Book-Reader und PDF-Werkzeug',
    template: '%s — LexiPulse',
  },
  description:
    'PDF und EPUB lesen, markieren, ausfüllen und unterschreiben — im Browser, ohne Upload. Dazu der Wortstrom: Wort für Wort an fester Position, wenn es schnell gehen muss.',
  ...
  openGraph: {
    ...
    url: SITE_URL,
    siteName: 'LexiPulse',
    title: 'LexiPulse — PDF-Reader, E-Book-Reader und PDF-Werkzeug',
    description:
      'Lesen, markieren, ausfüllen, unterschreiben — und Wort für Wort, wenn es schnell gehen muss. Alles im Browser, nichts wird hochgeladen.',
  ...
  twitter: {
    ...
    title: 'LexiPulse — PDF-Reader, E-Book-Reader und PDF-Werkzeug',
    description:
      'Lesen, markieren, ausfüllen, unterschreiben — alles im Browser, nichts wird hochgeladen.',
    images: ['/og-image.png'],
  },
